...
namespace Cache_Sample
{
    public partial class Form1 : Form
    {
        ...
        /// <summary>
        /// PokeIn Cache Class can be useful for any of your .NET Framework Solutions
        /// PCache provides thread safe interface between your application and in-memory data
        /// </summary>
        PCache _cache;
